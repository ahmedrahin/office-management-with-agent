                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Inquiry Person List</li>
                            </ol>
                        </div>                    
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title" style="display: flex;justify-content: space-between;align-items:center;">
                                <div>
                                     Inquiry Person ({{ $students->count() }})
                                </div>
                                <div>
                                   
                                    <a href="{{ route('agent-person.create') }}" class="btn btn-primary addnew"> <i class="ri-add-line"></i> Register New</a>
                                </div>
                            </h4>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($students as $student)
                                                <tr>
                                                    ...
                                                    <td class="action">
                                                        <button>
                                                            <a href="{{route('agent-person.edit',$student->id)}}">
            ...
            $('.deleteButton').click(function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            type: 'DELETE',
                            url: '{{ route("agent-person.destroy", ":id") }}'.replace(':id', id),
                            headers: {
