                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Your Register Student</li>
                            </ol>
                        </div>                    
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title" style="display: flex;justify-content: space-between;align-items:center;">
                                <div>
                                     Register Student ({{ $students->count() }})
                                </div>
                                <div>
                                   
                                    <a href="{{ route('student.create') }}" class="btn btn-primary addnew"> <i class="ri-add-line"></i> Register New</a>
                                </div>
                            </h4>
                            <div class="data">
                                @if( $students->count() == 0 )
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: center;">Processing Fees</th>
                                                <th>Mobile no.</th>
                                                <th>Register Date</th>
                                                {{-- <th>Details</th> --}}
                                                <th>Action</th>
                                            ...
                                            @foreach ($students as $student)
                                                <tr>
                                                   ...
                                                   <td>
                                                    ...
                                                    {{-- <td class="text-center">
                                                        <a href="{{ route('student.show', $student->id) }}" class="btn bg-primary text-white" style="font-size:13px;font-weight: 700;padding: 3px 8px;" target="_blank">
                                                            Details
                                                        </a>
                                                    </td> --}}
