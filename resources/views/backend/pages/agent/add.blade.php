                                ...
                                <div class="row">
                                     ...
                                     <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="phone"  placeholder="Whatsapp No." name="whatsapp">
                                            <div class="invalid-feedback"></div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="father_name"  placeholder="Father's Name" name="father_name">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label for="mother_name" class="form-label">Mother's Name</label>
                                            <input type="text" id="mother_name"  placeholder="Mother's Name" name="mother_name">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label for="spouse_name" class="form-label">Spouse Name (if applicable)</label>
                                            <input type="text" id="spouse_name" placeholder="Spouse Name" name="spouse_name">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="village"  placeholder="Village" name="village">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            <label for="ward_no" class="form-label">Ward No</label>
                                            <input type="text" id="ward_no" placeholder="Ward No" name="ward_no">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            <label for="sub_district" class="form-label">Upazila (Sub-district)</label>
                                            <input type="text" id="sub_district" placeholder="Upazila" name="sub_district">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="division" placeholder="Division" name="division">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="nid_number"  placeholder="NID Number" name="nid_number">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="passport_number" placeholder="Passport Number" name="passport_number">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <textarea id="current_address"  rows="3" placeholder="Current Address" name="current_address"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <textarea id="permanent_address" rows="3" placeholder="Permanent Address" name="permanent_address"></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" min="0" id="experience_years" placeholder="Years of Experience" name="experience_years">
                                        </div>
                                    </div>
                                </div>
