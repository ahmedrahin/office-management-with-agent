...
@section('page-title')
    <title>Edit Job Type || {{ \App\Models\Settings::site_title() }}</title>
@endsection
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{route('job.update', $data->id)}}" method="POST" class="needs-validation" novalidate>
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="validationName" placeholder="Job Type Name" name="name" value="{{ $data->name }}" required>
