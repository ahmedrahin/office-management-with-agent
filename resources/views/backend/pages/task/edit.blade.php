...
@section('page-title')
    <title>Edit Income || {{ \App\Models\Settings::site_title() }}</title>
@endsection
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {{-- edit data --}}
                            <div id="edit-data">
                                <form action="{{route('update.income', $editData->id)}}" method="POST" class="needs-validation" novalidate>
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="name" placeholder="title..." name="name" value="{{ $editData->name }}" required>
                                                <div class="invalid-feedback"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                <label for="amn" class="form-label">Amount</label>
                                                <input type="text" class="form-control" id="amn" placeholder="Amount" name="amn" value="{{$editData->amn}}" required>
                                                <div class="invalid-feedback"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                <label for="date" class="form-label" value="{{$editData->date}}">Income Date (optional)</label>
