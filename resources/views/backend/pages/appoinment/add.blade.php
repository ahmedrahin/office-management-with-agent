                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group" id="datepicker1">
                                                <input type="text" class="form-control" placeholder="dd M, yyyy"
                                                    data-date-format="dd M, yyyy" data-date-container='#datepicker1' data-provide="datepicker" name="date" autocomplete="off" required>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea id="elm1" placeholder="Write here.." name="note"></textarea>
                                        </div>
                                    </div>
                                </div>
