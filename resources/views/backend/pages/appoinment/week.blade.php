...
@section('page-title')
    <title>Week Appointment  List || {{ \App\Models\Settings::site_title() }} </title>
@endsection
                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Week Appointment </li>
                            </ol>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <h4 class="card-title">
                                ...
                                <div class="btn btn-group">
                                    ...
                                    <a href="{{route('appoinment.week')}}" class="btn btn-primary" style="background: #0c7dc2;">This Week Appointment </a>
                                </div>
                            </h4>
