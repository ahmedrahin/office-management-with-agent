...
@section('page-title')
    <title>Add New Package || {{ \App\Models\Settings::site_title() }}</title>
@endsection
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title" style="display: flex;justify-content: space-between;align-items:center;">
                                ...
                                <div>
                                    <a href="{{ route('package.index') }}" class="btn btn-primary addnew"> <i class="ri-arrow-left-line"></i> All Packages</a>
                                </div>
                            </h4>
                            ...
                            <form action="{{route('package.store')}}" method="POST" class="needs-validation" novalidate>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="validationName" placeholder="Package Name" name="name" required>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="Day/Night" placeholder="Day/Night" name="day_night" required>
                                            <div class="invalid-feedback"></div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="price" placeholder="Package Price" name="price" required>
                                            <div class="invalid-feedback"></div>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    <button class="btn btn-primary" type="submit" id="addEmployee"> Save Package </button>
                                </div>
                            </form>
                        </div>
                    </div>
