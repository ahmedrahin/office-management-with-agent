...
@section('page-title')
    <title>Manage Register Person || {{ \App\Models\Settings::site_title() }}</title>
@endsection
                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">All Register Person</li>
                            </ol>
                        </div>                    
                        ...
                        <div class="card-body">
                            ...
                            <h4 class="card-title" style="display: flex;justify-content: space-between;align-items:center;">
                                ...
                                <div>
                                    ...
                                    <a href="{{ route('inquiry.create') }}" class="btn btn-primary addnew"> <i class="ri-add-line"></i> Register New</a>
                                </div>
                            </h4>
                                            ...
                                            @foreach ($students as $student)
                                                <tr>
                                                   ...
                                                   <td>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="{{ route('inquiry.show', $student->id) }}" class="btn bg-primary text-white" style="font-size:13px;font-weight: 700;padding: 3px 8px;" target="_blank">
                                                            Details
                                                        </a>
                                                    </td>
                                                    ...
                                                    <td class="action">
                                                        <button>
                                                            <a href="{{route('inquiry.edit',$student->id)}}">
           ...
           <div class="row">
                <div class="col-md-5">
                    <div>
                        ...
                        <!-- Filter Form -->
                        <form method="GET" action="{{ route('inquiry.index') }}" id="filterForm" style="margin-bottom: 30px;">
                            ...
                            @if(request('start_date') || request('end_date') || request('user_type'))
                                <a href="{{ route('inquiry.index') }}" class="btn btn-secondary mt-2">Show All</a>
                            @endif
                        </form>
