...
@section('page-title')
    <title>All Tourist Place List || {{ \App\Models\Settings::site_title() }}</title>
@endsection
                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">All Tourist Place List</li>
                            </ol>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title" style="display: flex;justify-content: space-between;align-items:center;">
                                <div>
                                    All Tourist Place List
                                </div>
                                <div>
                                    <a href="{{ route('tourist.create') }}" class="btn btn-primary addnew"> <i class="ri-add-line"></i> Add New</a>
                                </div>
                            </h4>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($data as $v)
                                                <tr>
                                                    ...
                                                    <td class="action">
                                                        <button>
                                                            <a href="{{route('tourist.edit',$v->id)}}">
