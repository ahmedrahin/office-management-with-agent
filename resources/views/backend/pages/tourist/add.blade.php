...
@section('page-title')
    <title>Add New Tourist Place || {{ \App\Models\Settings::site_title() }}</title>
@endsection
                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Add New Tourist Place</li>
                            </ol>
                        </div>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{route('tourist.store')}}" method="POST" class="needs-validation" novalidate>
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="validationName" placeholder="Tourist Place Name" name="name" required>
