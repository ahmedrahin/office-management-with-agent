...
@section('page-title')
    <title>Add New University || {{ \App\Models\Settings::site_title() }}</title>
@endsection
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{route('university.store')}}" method="POST" class="needs-validation" novalidate>
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="validationName" placeholder="University Name" name="name" required>
