...
@section('page-title')
    <title>Add New Subject || {{ \App\Models\Settings::site_title() }}</title>
@endsection
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="validationName" placeholder="Subject Name" name="name" required>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="validationName" placeholder="Processing Fees" name="price" required>
                                            <div class="invalid-feedback"></div>
                                        </div>
                                    </div>
